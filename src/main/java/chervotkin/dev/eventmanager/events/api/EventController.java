...
import chervotkin.dev.eventmanager.events.domain.EventService;
...
public class EventController {
    ...
    public EventController(EventService eventService, EventDtoMapper eventDtoMapper, UserService userService) {
        this.eventService = eventService;
        this.dtoMapper = eventDtoMapper;
    ...
    public ResponseEntity<List<EventDto>> getUserEvents() {
        log.info("Get request for all get user events");
